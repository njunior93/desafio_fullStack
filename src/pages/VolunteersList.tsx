...
const VolunteersList = () => {
  ...
  const softDeleteVolunteer = async (id: number) => {
    try {
      ...
      setAlert(
        alertMessage(
          "Erro ao tentar inativar voluntário!",
          "error",
          <ReportProblemIcon />,
        ),
      );
        ...
        <div className="w-full max-w-4xl flex flex-col gap-8 m-4">
          <div className="w-full flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 p-2">
            <div className="flex flex-col items-start gap-1">
              ...
              <Typography variant="body2" color="text.secondary">
                Gerencie cadastros, visualize informações e acompanhe
                voluntários
              </Typography>
            </div>
          ...
          <div className="flex flex-col gap-6">
            ...
            <TableContainer
              component={Paper}
              elevation={1}
              className="rounded-xl border border-gray-200 w-full overflow-x-auto max-h-[500px] overflow-y-auto"
            >
              <Table
                          ...
                          const filterAvali =
                            availabilityFilter === "todos"
                              ...
                              : volunteer.availability
                                  ?.toLowerCase()
                                  .includes(
                                    availabilityFilter.toLocaleLowerCase(),
                                  );
                          ...
                          <TableCell align="right">
                            ...
                            >
                              <IconButton
                                ...
                                onClick={() => pageEditVolunteer(volunteer.id)}
                                size="small"
                              >
                              ...
                              {volunteer.status === true ? (
                                <IconButton
                                  disabled={isDeleting || isUpdating}
                                  onClick={() =>
                                    softDeleteVolunteer(volunteer.id)
                                  }
                                  size="small"
                                >
